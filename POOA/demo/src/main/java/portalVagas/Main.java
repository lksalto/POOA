...
public class Main {
    public static void main(String[] args) {
        ...
        Empresa empresa1 = (Empresa) userFactory.criaEmpresa("TechCorp", "techplus@exemplo.com", 
                                                ...
                                                "Sao Paulo", portal1);
        Funcionario funcionario1 = (Funcionario) userFactory.criaFuncionario("Fulano", "fulano@gmail.com",
                                                        "Senha123","123.123.123-09", 
                                                    "(11) 1234-5678", "Masculino", 
                                                    "09/02/1931" , portal1);
        ...
        //Adicionar vagas, utilizando Observer para informar o funcionário que está no portal.
